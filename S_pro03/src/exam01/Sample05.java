...
public class Sample05 {
	...
	public static void main(String[] args) {
		 ...
		 * 		- 주로 메뉴 번호를 선택하고 특정 멤뉴에 대한 코드를 실행 시킬 때 사용.
		 * 		- switch는 if문과 다르게 조건이 만족한다고 해서 해당 조건에 해당하는 코드만 수행하고 종료되지 않는다.
		 * 		  조건이 만족한 case부터 순차적으로 모든 case의 코드를 실행한다.
		 * 		  이러한 특징 때문에 특정 case의 코드만 실행하고 종료되기 원하는 경우 break; 문을 사용하여 종료시켜야 한다.
		 */
		 ...
		 * 
		 * 			case 식에 대한 결과값3:
		 *  			결과값3에 해당하는 경우 실행할 코드
		 *  			break;
		 *  
		 *  		case ...:
		 *  
		 *  		default:
		 *  			위에 나열한 case에 해당하지 않는 경우 실횅할 코드
		 *  			if문의 else처럼 옵션이다. 없어도 됨!
		 * 		}
		 */
